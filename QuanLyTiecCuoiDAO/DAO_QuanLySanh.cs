...
namespace DAO
{
    public class DAO_QuanLySanh
    {
        ...
        {
            string sqlCommand = @"SELECT MaSanh, TenSanh, LoaiSanh.MaLoaiSanh, SoLuongBanToiDa, DonGiaBanToiThieu, GhiChu FROM LoaiSanh, Sanh WHERE LoaiSanh.MaLoaiSanh = Sanh.MaLoaiSanh";
